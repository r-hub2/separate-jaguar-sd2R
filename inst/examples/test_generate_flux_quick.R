#!/usr/bin/env Rscript
# Flux.1 quick profiler — 768x768, 10 steps
# Run: Rscript /mnt/Data2/DS_projects/sd2R/inst/examples/test_generate_flux_quick.R
...
cat("Saved: /tmp/sd2R_flux_quick.png\n")
